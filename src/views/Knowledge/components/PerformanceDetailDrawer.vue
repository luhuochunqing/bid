  ...
  >
    ...
    <el-tabs v-model="activeDetailTab" class="detail-tabs">
        ...
        <div class="attachment-detail-list">
          ...
          <el-table :data="data.attachments" border style="width: 100%">
            ...
            <el-table-column label="下载链接">
              <template #default="{ row }">
                <a :href="row.fileUrl" target="_blank" class="link-url">
                  查看/下载附件
                </a>
              </template>
            </el-table-column>
      ...
      <el-tab-pane label="操作日志" name="logs">
        <div class="logs-pane">
          <el-timeline>
            <el-timeline-item timestamp="2026-05-31 09:12:00" type="primary">
              <h4>业务数据更新</h4>
              <p>管理员 更新了该业绩合同截止日期及附加文件</p>
            </el-timeline-item>
            <el-timeline-item timestamp="2026-05-30 14:05:22" type="success">
              <h4>建立业绩档案</h4>
              <p>录入人 初始录入该合同关键台账并关联附件</p>
            </el-timeline-item>
          </el-timeline>
        </div>
      </el-tab-pane>
