<template>
  ...
  <el-card class="stage-view" shadow="never">
    ...
    <div class="bid-reviewer-row">
      ...
      <el-select v-model="bidReviewerId" filterable remote placeholder="模糊搜索选择审核人" :remote-method="searchReviewer" :loading="reviewerSearching" style="width:280px" clearable :disabled="reviewState === 'reviewing' || reviewState === 'approved'">
  ...
  <el-card v-if="reviewState === 'approved'" class="stage-view" shadow="never">
    ...
    <div class="complete-bid-row">
      <el-checkbox v-model="bidSubmitted">已完成投标</el-checkbox>
