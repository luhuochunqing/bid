    ...
    <div v-if="isApplicable">
      ...
      <el-form label-width="140px">
        <el-form-item label="复盘报告">
          ...
          >
            <el-button type="primary" :disabled="locked">上传复盘报告</el-button>
            <template #tip>
      ...
      <!-- 提交按钮（已提交后置灰，不可重复提交） -->
      <el-form v-if="canEdit" label-width="140px">
        <el-form-item>
          <el-button type="primary" :loading="submitting" :disabled="locked" @click="submit">提交复盘</el-button>
        </el-form-item>
      </el-form>
...
/** 当前用户是否有复盘编辑权限（须与后端 retrospective.submit 权限一致） */
