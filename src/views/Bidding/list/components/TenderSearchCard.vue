...
.tender-search-card :deep(.filter-select), .tender-search-card :deep(.filter-select *), .tender-search-card :deep(.search-input), .tender-search-card :deep(.search-input *) { outline: none; }
.tender-search-card :deep(.filter-select:focus-visible), .tender-search-card :deep(.filter-select *:focus-visible), .tender-search-card :deep(.search-input:focus-visible), .tender-search-card :deep(.search-input *:focus-visible) { outline: 2px solid var(--el-color-primary-light-3, #66b1ff) !important; outline-offset: -2px; border-radius: var(--el-border-radius-base, 4px); }
.tender-search-card :deep(.el-input:focus-within), .tender-search-card :deep(.el-select:focus-within), .tender-search-card :deep(.el-button:focus), .tender-search-card :deep(.el-button:focus-visible), .tender-search-card :deep(.el-button:active) { outline: none; box-shadow: none; }
.tender-search-card :deep(.el-input:focus-within), .tender-search-card :deep(.el-select:focus-within) { box-shadow: 0 0 0 2px var(--el-color-primary-light-3, #66b1ff) !important; border-radius: var(--el-border-radius-base, 4px); }
.tender-search-card :deep(.el-input__wrapper:focus), .tender-search-card :deep(.el-input__wrapper:focus-visible), .tender-search-card :deep(.el-input__wrapper:active), .tender-search-card :deep(.el-select__wrapper:focus), .tender-search-card :deep(.el-select__wrapper:focus-visible), .tender-search-card :deep(.el-select__wrapper:active) { outline: none; box-shadow: none; }
.tender-search-card :deep(.el-input__inner), .tender-search-card :deep(.el-input__inner:focus), .tender-search-card :deep(.el-input__inner:focus-visible), .tender-search-card :deep(.el-select .el-input__inner:focus-visible), .tender-search-card :deep(.el-select__input), .tender-search-card :deep(.el-select__input:focus), .tender-search-card :deep(.el-select__input:focus-visible) { outline: none; box-shadow: none; }
