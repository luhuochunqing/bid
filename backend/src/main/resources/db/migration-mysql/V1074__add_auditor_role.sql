...
values
    ...
    ('bidAdmin', '投标部门管理员', '复盘审核与结项闸门审批', true, true, 'all',
     ...
     current_timestamp(6), current_timestamp(6)),
    ('bid-TeamLeader', '投标组长', '标书编制与评标推进负责人', true, true, 'all',
     ...
     current_timestamp(6), current_timestamp(6)),
    ('bid-projectLeader', '项目负责人', '立项发起人，维护客户与开标信息', true, true, 'self',
    ...
    ('task_executor', '任务执行人', '标书任务承接与执行', true, true, 'self',
     ...
     current_timestamp(6), current_timestamp(6)),
    ('bid-Team', '投标专员', '投标辅助、标书审核与任务处理', true, true, 'self',
     ...
     current_timestamp(6), current_timestamp(6)),
    ('bid-administration', '行政人员', '资质证书管理与行政事务', true, true, 'self',
