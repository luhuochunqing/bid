...
-- 如需精确回滚，请在执行 V1148 前对 tenders.department 和 project_initiation_details.leader_department
-- 做快照备份。V1148 执行前建议对上述两字段做 SELECT 备份。
UPDATE tenders
SET department = NULL
