-- Input: migration-mysql/V1089__append_task_board_permission_to_bid_other_dept.sql
...
-- If manual rollback is required, remove only the appended task-board token from bid_other_dept after confirming it was introduced by V1089.
