...
public class PersonnelImportTemplateGenerator {
    ...
    private static final String[] INSTRUCTION_CONTENT = {
            ...
            "  姓名：必填",
            "  性别：选填，下拉选择 男/女",
            "  入职日期：支持多种格式，如 2024-01-15、2024/01/15、2024年1月15日、2024.01.15、15/1/2024、01/15/2024、15.01.2024",
            "  出生日期：支持多种格式，如 1990-01-15、1990/01/15、1990年1月15日、1990.01.15、15/1/1990、01/15/1990、15.01.1990",
            "  手机号码：选填",
            ...
            "  姓名：选填，用于交叉校验",
            "  学校名称：必填",
            "  入学时间：选填，支持多种格式，如 YYYY-MM（2024-01）、2024/01、2024.01、2024年1月、1/2024、2024-01-15（自动截取年月）",
            "  毕业时间：必填，支持多种格式，如 YYYY-MM（2024-01）、2024/01、2024.01、2024年1月、1/2024、2024-01-15（自动截取年月）",
            ...
            "  发证日期：支持多种格式，如 2024-01-15、2024/01/15、2024年1月15日、2024.01.15、15/1/2024、01/15/2024、15.01.2024",
            "  到期日期：支持多种格式，如 2029-01-15、2029/01/15、2029年1月15日、2029.01.15、15/1/2029、01/15/2029、15.01.2029，到期后系统将发送提醒",
            ...
            "五、注意事项",
            "  1. 请勿修改表头行（第一行）",
            "  2. 日期格式：系统支持多种常见日期格式，如 2024-01-15、2024/01/15、2024年1月15日、2024.01.15、15/1/2024、01/15/2024、15.01.2024",
            "  3. 必填字段不可为空",
            "  4. 工号在同一批次中不可重复",
            "  5. 建议单次导入不超过1000条记录"
    };
