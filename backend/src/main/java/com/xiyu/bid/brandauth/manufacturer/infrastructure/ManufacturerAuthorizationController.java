...
public class ManufacturerAuthorizationController {
    ...
    public ResponseEntity<ManufacturerAuthorizationDTO> update(
        ...
        return ResponseEntity.ok(updateService.update(id, cmd));
    }
    ...
    public ResponseEntity<ManufacturerAuthorizationDTO> revoke(
        ...
        return ResponseEntity.ok(revokeService.revoke(id, cmd.reason()));
    }
    ...
    private static List<ProductLine> parseProductLines(
        ...
        for (String v : values) {
            ProductLine.fromString(v).ifPresentOrElse(
                    result::add,
                    () -> {
